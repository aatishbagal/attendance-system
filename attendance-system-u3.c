//gcc attendance-system-u3.c -I \PDCurses -L PDCurses\wincon -lpdcurses -o attendance-system-u3.exe
//gcc attendance-system-u3.c -lncurses -o attendance-system-u3
